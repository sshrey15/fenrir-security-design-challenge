        ...
        <p className="mt-2 text-sm text-gray-500">
          {isLogin ? (
            <>
              ...
              <button onClick={() => setIsLogin(false)} className="text-[#0CC8A8] hover:underline font-medium cursor-pointer">
                Sign up
              </button>
            </>
          ) : (
            <>
              ...
              <button onClick={() => setIsLogin(true)} className="text-[#0CC8A8] hover:underline font-medium cursor-pointer">
                Log in
              </button>
            </>
          )}
        ...
        <div className="relative">
          ...
          >
            {showPassword ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.97 9.97 0 012.31-3.814M6.938 6.937A9.966 9.966 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.973 9.973 0 01-4.293 5.149M15 12a3 3 0 11-6 0" />
