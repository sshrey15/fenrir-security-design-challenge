...
export default function Home() {
  return (
    <div className="relative font-sans min-h-screen w-full  bg-auth flex items-center justify-center p-6 md:p-12 overflow-hidden">
      
      
     
      <div className="absolute top-8 left-8 flex items-center gap-2">
        <div className="w-6 h-6 bg-white rounded-full border-5 border-[#009B95]" />
        <span className="text-white text-md md:text-2xl font-bold tracking-tight">aps</span>
      </div>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="text-white space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">What &[apos]s included</h3>
            <ul className="space-y-3 font-semibold">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-gray-300 text-sm">
                  <span className="text-[#009B95] mt-1">✓</span>
                  {item}
                </li>
              ))}
            </ul>
